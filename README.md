...
- `TESTDATASET.c`: Contains the main function (needs to be compiled separately to `main.c`), which automatically creates a dataset of 10 books, with a random number of pages between 10 to the power of 3 and 10 to the power of 8; also prints the execution time of the algorithm. $10^3$
